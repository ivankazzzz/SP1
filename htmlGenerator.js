...
xlsxFile("../../../OneDrive/Translation/Periodic Table others.xlsm").then((rows) => {
  ...
  languages.forEach((language) => {
    ...
    let defaultFooter = [
      ...
      "<div class='flex flex-wrap justify-center p-2 pb-8 self-center'>Made for&nbsp; <span style='color:#e25555'>❤</span> &nbsp;by <a target='_blank' href='https://twitter.com/MrNaveenCS/' rel='noopener noreferrer'>",
      "<span class='linkText'>Irfan Ananda Ismail S.Pd</span>",
      "</a></div>",
      "</section>",
